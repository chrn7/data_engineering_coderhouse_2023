...
- user_redshift.txt: archivo .txt conteniendo mi nombre de usuario de la Base de Datos de Redsfhit en la cual queremos insertar los datos extraidos de la API de Youtube (en la tabla "videos" de esa Base de Datos de Redsfhit).
- redshift_password.txt: archivo .txt conteniendo la contraseña de mi Base de Datos de Redshift en la cual queremos insertar los datos extraidos de la API de Youtube (en la tabla "videos" de esa Base de Datos de Redsfhit).
- api_key_youtube.txt : archivo conteniendo el client_api_key de la API de Youtube.
